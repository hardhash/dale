...
* CV
  * [MMPretrain的图像分类任务解决方案](cv/cls/)

* NLP
  * [NLP系列阅读指引（开始前必读）](nlp/introduction/)
  * 2022年以前的NLP-时代的眼泪
    * [自然语言转化为机器语言](nlp/n2l/)
    * [RNN系列](nlp/rnn_series/)
    * [注意力机制架构](nlp/transformer_construction/)
    * [注意力机制的相关思考](nlp/transformer/)
    * [WaveNet(1DCNN的尝试)](nlp/waveNet/)
  * 大模型时代的NLP
    * [ModelScope(国内网络模型下载)](nlp/modelscope/)
    * [Transformers基础组件](nlp/huggingface/base/)
    * [Transformers框架训练预训练模型](nlp/huggingface/pretrain/)
    * [命名实体识别(NER)解决方案](nlp/huggingface/ner/)
    * [机器阅读理解(MRC)解决方案](nlp/huggingface/read_comprehension/)
    * [多项选择(Multi-Choice)解决方案](nlp/huggingface/multichoice/)
    * [文本相似度匹配(Text-Match)解决方案](nlp/huggingface/wide/)
    * [文本摘要(Text-Summarization)解决方案](nlp/huggingface/abstract/)
    * [Transformers如何改变NLP生态](nlp/huggingface/solution/)
    * [BitFit](nlp/peft/bitfit/)
    * [(PEFT)Prompt-Tuning](nlp/peft/prompt-tuning/)
    * [(PEFT)P-Tuning](nlp/peft/p-tuning/)
    * [(PEFT)Prefix-Tuning](nlp/peft/prefix-tuning/)
    * [(PEFT)LoRa](nlp/peft/lora/)
    * [(PEFT)IA3](nlp/peft/IA3/)
    * [PEFT微调自定义模型和适配器载入/禁用](nlp/peft/module/)
    * [16bits半精度训练](nlp/bitsandbytes/16bit/)
    * [大模型推理与量化算法](nlp/bitsandbytes/8bit&4bit/)

* 图模型
  * 图机器学习
    * [图的基本表示](graph/ml/base_show/)
    * [图机器学习特征工程](graph/ml/feature_engineering/)
    * [PageRank数学推论](graph/ml/pagerank/)
    * [图嵌入](graph/ml/graph_emb/)
    * [直推式学习：标签传播和半监督节点分类](graph/ml/linepush_learn/)

  * 图神经网络
    * [万物皆可GNN](graph/gnn/environment/)
    * [GCN](graph/gnn/gcn/)

  * PyG(Pytorch-Geometric)
    * [安装](graph/pyg/install_pyg/)
    * [PyG基本使用](graph/pyg/basic_use/)
    * [基于点的图预测任务](graph/pyg/inf_paper/)
    * [构建自己的数据集](graph/pyg/create_data/)
...
* 论文精读
  * 计算机视觉
    * ILSVRC系列
      * [AlexNet](paper_read/cv/ILSVRC/alexnet/) 
      * [VGG](paper_read/cv/ILSVRC/vgg/)
      * [GoogLeNet_v1](paper_read/cv/ILSVRC/googlenet_v1/)
      * [GoogLeNet_v2](paper_read/cv/ILSVRC/googlenet_v2/)
      * [GoogLeNet_v3](paper_read/cv/ILSVRC/googlenet_v3/)
      * [ResNet](paper_read/cv/ILSVRC/resnet/)
      * [GoogLeNet_v4](paper_read/cv/ILSVRC/googlenet_v4/)
      * [ResNeXt](paper_read/cv/ILSVRC/resnext/)
      * [DenseNet](paper_read/cv/ILSVRC/densenet/)
      * [SENet](paper_read/cv/ILSVRC/senet/)
    * 目标分割
    * 目标检测
    * transformer
    * 新时代卷积backbones
  ...
  * 可解释机器学习
    * [LIME](paper_read/explanation/LIME/)
    * [CAM串讲](paper_read/explanation/CAM/)

* 竞赛总结
    * [(2024 CV)Kaggle: HMS (**TOP 3%**)](competitions/HMS/)
    * [(2023 数据挖掘)Seed2023新能源(**TOP 10%**)](competitions/seed2023xny/)
    * [(2023 OCR)厦门国际银行建模大赛(**TOP 6%**)](competitions/xiamen_ocr/)
...
* 参与重大科研项目
  * [国家重点研发计划"微塑料源头替代削减与过程阻断调控技术"(2020YFC1909503-04)](research_Project/2020YFC1909503-04/)
